...
namespace VestaBusters.CoreLibrary
{
    ...
    public class CallbackDispatcher : PrivateSingletonBehaviour<CallbackDispatcher>
    {
        ...
        public static void InvokeOnMainThread<TResult>(CompletionCallback<TResult> callback, TResult result,
            Error error)
        {
            // validate arguments
            if (callback == null)
        ...
        public static void InvokeOnMainThread<TResult>(EventCallback<TResult> callback,
            IOperationResultContainer<TResult> resultContainer)
        {
