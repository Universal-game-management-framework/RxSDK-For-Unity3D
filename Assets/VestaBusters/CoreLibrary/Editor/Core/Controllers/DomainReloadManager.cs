...
namespace VestaBusters.CoreLibrary.Editor
{
    public static class DomainReloadManager
    {
        ...
        private const BindingFlags kDefaultBindingAttr =
        ...
        private static void ClearProperty(PropertyInfo propertyInfo, ClearOnReloadAttribute clearAttribute)
        {
            ...
            try
            {
                DebugLogger.Log(CoreLibraryDomain.Default,
                    $"Clearing property {propertyInfo.Name} to value {resetValue}.");
        ...
        private static object FindMemberResetValue(Type target, ClearOnReloadAttribute clearAttribute)
        {
            ...
            if (ClearOnReloadOption.Custom == clearAttribute.Option)
            {
                ...
                {
                    Debug.LogWarning(
                        "Unable to assign value of type {valueToAssign.GetType()} to field {field.Name} of type {fieldType}.");
                }
            }
