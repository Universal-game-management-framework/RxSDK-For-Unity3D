...
namespace VestaBusters.EssentialKit.BillingServicesCore.iOS
{
    internal static class BillingServicesBinding
    {
        ...
        /*[DllImport("__Internal")]
        public static extern void NPBillingServicesGetOriginalTransaction(IntPtr transactionPtr, ref SKPaymentTransactionData data);*/ //@@ Disabling as it's currently unused.
