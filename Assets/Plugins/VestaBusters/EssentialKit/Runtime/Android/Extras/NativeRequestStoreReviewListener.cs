...
namespace VestaBusters.EssentialKit.ExtrasCore.Android
{
    public class NativeRequestStoreReviewListener : AndroidJavaProxy
    {
        ...
        public NativeRequestStoreReviewListener() : base("com.vestabusters.essentialkit.extras.IStoreReview$IRequestStoreReviewListener")
        {
        }
