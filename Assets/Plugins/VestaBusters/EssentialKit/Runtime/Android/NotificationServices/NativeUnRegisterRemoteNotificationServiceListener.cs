...
namespace VestaBusters.EssentialKit.NotificationServicesCore.Android
{
    public class NativeUnregisterRemoteNotificationServiceListener : AndroidJavaProxy
    {
        ...
        public NativeUnregisterRemoteNotificationServiceListener() : base("com.vestabusters.essentialkit.notificationservices.INotificationServices$IUnregisterRemoteNotificationServiceListener")
        {
        }
