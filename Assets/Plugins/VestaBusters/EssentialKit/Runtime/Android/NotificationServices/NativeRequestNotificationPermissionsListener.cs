...
namespace VestaBusters.EssentialKit.NotificationServicesCore.Android
{
    public class NativeRequestNotificationPermissionsListener : AndroidJavaProxy
    {
        ...
        public NativeRequestNotificationPermissionsListener() : base("com.vestabusters.essentialkit.notificationservices.INotificationServices$IRequestNotificationPermissionsListener")
        {
        }
