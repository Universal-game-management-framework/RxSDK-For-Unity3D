...
namespace VestaBusters.EssentialKit.NotificationServicesCore.Android
{
    public class NativeRegisterRemoteNotificationsListener : AndroidJavaProxy
    {
        ...
        public NativeRegisterRemoteNotificationsListener() : base("com.vestabusters.essentialkit.notificationservices.INotificationServices$IRegisterRemoteNotificationsListener")
        {
        }
