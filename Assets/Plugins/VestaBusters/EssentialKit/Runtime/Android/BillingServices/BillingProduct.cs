...
#region Constructors
        ...
        public BillingProduct(string id, NativeBillingProduct nativeBillingProduct,
            IEnumerable<BillingProductPayoutDefinition> payouts)
            : base(id: id, platformId: nativeBillingProduct.GetProductIdentifier(), payouts: payouts)
        {
