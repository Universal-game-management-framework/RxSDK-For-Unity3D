...
namespace VestaBusters.EssentialKit.AddressBookCore.Android
{
    public class NativeRequestContactsPermissionListener : AndroidJavaProxy
    {
        ...
        public NativeRequestContactsPermissionListener() : base("com.vestabusters.essentialkit.addressbook.IAddressBookHandler$IRequestContactsPermissionListener")
        {
        }
