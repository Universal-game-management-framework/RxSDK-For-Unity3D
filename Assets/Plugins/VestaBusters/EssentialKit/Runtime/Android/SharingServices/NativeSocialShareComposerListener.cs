...
namespace VestaBusters.EssentialKit.SharingServicesCore.Android
{
    public class NativeSocialShareComposerListener : AndroidJavaProxy
    {
        #region Delegates

        public delegate void OnActionDelegate(NativeSocialShareComposerResult result);
        ...
        public NativeSocialShareComposerListener() : base("com.vestabusters.essentialkit.sharingservices.ISharing$ISocialShareComposerListener")
        {
        }
        ...
        public void onAction(AndroidJavaObject result)
        {
            ...
            {
                onActionCallback(NativeSocialShareComposerResultHelper.ReadFromValue(result));
            }
        }
