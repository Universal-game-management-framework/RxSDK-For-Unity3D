...
namespace VestaBusters.EssentialKit.NetworkServicesCore.Android
{
    public class NativeNetworkChangeListener : AndroidJavaProxy
    {
        ...
        public NativeNetworkChangeListener() : base("com.vestabusters.essentialkit.networkservices.INetworkServices$INetworkChangeListener")
        {
        }
