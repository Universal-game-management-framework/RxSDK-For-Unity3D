...
namespace VestaBusters.EssentialKit.Common.Android
{
    public class NativeLoadAssetListener : AndroidJavaProxy
    {
        ...
        public NativeLoadAssetListener() : base("com.vestabusters.essentialkit.utilities.common.interfaces.ILoadAssetListener")
        {
        }
