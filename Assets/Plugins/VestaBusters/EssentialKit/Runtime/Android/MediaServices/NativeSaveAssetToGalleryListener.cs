...
namespace VestaBusters.EssentialKit.MediaServicesCore.Android
{
    public class NativeSaveAssetToGalleryListener : AndroidJavaProxy
    {
        #region Delegates
        ...
        public NativeSaveAssetToGalleryListener() : base("com.vestabusters.essentialkit.mediaservices.IMediaServices$ISaveAssetToGalleryListener")
        {
        }
