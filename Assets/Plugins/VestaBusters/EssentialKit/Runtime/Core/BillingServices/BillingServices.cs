...
using VestaBusters.EssentialKit.BillingServicesCore;
...
namespace VestaBusters.EssentialKit
{
    ...
    public static class BillingServices
    {
        ...
        public static void Initialize(BillingServicesUnitySettings settings)
        {
            ...
            // Configure interface
            s_nativeInterface           = NativeFeatureActivator.CreateInterface<INativeBillingServicesInterface>(ImplementationSchema.BillingServices, settings.IsEnabled);
        ...
        public static bool BuyProduct(string productId, int quantity = 1, string applicationUsername = null)
        {
            ...
            {
                DebugLogger.LogWarning(EssentialKitDomain.Default, "Product not found.");
                return false;
            }
        ...
        public static bool BuyProduct(IBillingProduct product, int quantity = 1, string applicationUsername = null)
        {
            ...
            try
            {
                ...
                DebugLogger.LogError(EssentialKitDomain.Default, $"Failed to initiate product purchase. Error: {error}.");
                return false;
            }
            catch (Exception exception)
            {
        ...
        private static void HandleOnRetrieveProductsComplete(IBillingProduct[] products, string[] invalidProductIds, Error error)
        {
            ...
            if (error == null)
            {
                ...
                {
                    DebugLogger.Log(EssentialKitDomain.Default, "Found unfinished transactions. We are attempting to handle it, make sure you are calling BillingServices.FinishTransactions after processing transactions.");
                }
            }
        }
