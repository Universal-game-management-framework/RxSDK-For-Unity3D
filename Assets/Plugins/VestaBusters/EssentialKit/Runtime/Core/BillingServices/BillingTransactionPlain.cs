...
namespace VestaBusters.EssentialKit.BillingServicesCore
{
    public sealed class BillingTransactionPlain : BillingTransactionBase
    {
        ...
        public BillingTransactionPlain(string transactionId, IBillingPayment payment,
            DateTime transactionDate, BillingTransactionState transactionState,
            BillingReceiptVerificationState verificationState, string receipt,
            Error error = null)
