...
namespace VestaBusters.EssentialKit
{
    ...
    {
        public  const   string      kMain                   = "VestaBusters.EssentialKit";
        
        public  const   string      kIos                    = "VestaBusters.EssentialKit.iOSModule";
        
        public  const   string      kAndroid                = "VestaBusters.EssentialKit.AndroidModule";
        
        public  const   string      kSimulator              = "VestaBusters.EssentialKit.SimulatorModule";
    }

    public static class NamespaceName
    {
        public  const   string      kRoot                   = "VestaBusters.EssentialKit";
                    ...
                    new NativeFeatureRuntimeConfiguration(packages: new NativeFeatureRuntimePackage[]
                                                          {
                                                            NativeFeatureRuntimePackage.iOS(assembly: AssemblyName.kIos,
                                                                                            ...
                                                                                            bindingTypes: new string[] { "ScoreBinding", "PlayerBinding", "LeaderboardBinding", "GameCenterBinding", "AchievementDescriptionBinding", "AchievementBinding" }),
                                                            NativeFeatureRuntimePackage.Android(assembly: AssemblyName.kAndroid,
                    ...
                    new NativeFeatureRuntimeConfiguration(packages: new NativeFeatureRuntimePackage[]
                                                          {
                                                            NativeFeatureRuntimePackage.iOS(assembly: AssemblyName.kIos,
                                                                                            ...
                                                                                            bindingTypes: new string[] { "MediaServicesBinding" }),
                                                            NativeFeatureRuntimePackage.Android(assembly: AssemblyName.kAndroid,
