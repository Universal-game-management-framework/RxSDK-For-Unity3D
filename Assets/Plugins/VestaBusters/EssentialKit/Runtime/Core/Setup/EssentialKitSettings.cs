...
namespace VestaBusters.EssentialKit
{
    ...
    {
        public static string Default => "VestaBusters.CoreLibrary.EssentialKit";
    }
    ...
    public class EssentialKitSettings : SettingsObject
    {
        ...
        internal static UnityPackageDefinition Package => ObjectHelper.CreateInstanceIfNull(
            ...
            () =>
            {
                return new UnityPackageDefinition(name: "com.vestabusters.essentialkit",
                                                  displayName: "Essential Kit",
                                                  version: "2.7.1",
                                                  defaultInstallPath: $"Assets/Plugins/VestaBusters/EssentialKit",
