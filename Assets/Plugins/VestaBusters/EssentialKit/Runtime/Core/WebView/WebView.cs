...
using VestaBusters.EssentialKit.WebViewCore;
...
namespace VestaBusters.EssentialKit
{
    ...
    /// </summary>
    /// <description>
    /// To do so, drag and drop the WebView prefab into scene heirarchy, which is placed under folder <i>Assets/VestaBusters/NativePlugins/Prefab</i>. 
    ...
    public sealed class WebView : NativeFeatureBehaviour
    {
        ...
        protected override void AwakeInternal(object[] args)
        {
            ...
            m_nativeInterface   = NativeFeatureActivator.CreateInterface<INativeWebView>(ImplementationSchema.WebView, Settings.IsEnabled);
