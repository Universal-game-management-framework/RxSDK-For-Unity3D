...
using VestaBusters.EssentialKit.NotificationServicesCore;
...
namespace VestaBusters.EssentialKit
{
    ...
    public static class NotificationServices
    {
        ...
        public static void Initialize(NotificationServicesUnitySettings settings)
        {
            ...
            // Configure interface
            s_nativeInterface       = NativeFeatureActivator.CreateInterface<INativeNotificationCenterInterface>(ImplementationSchema.NotificationServices, settings.IsEnabled);
        ...
        [Obsolete("This method is deprecated. Use ScheduleNotification(INotification, CompletionCallback) instead.", false)]
        public static void ScheduleNotification(INotification notification, CompletionCallbackLegacy callback = null)
        {
            ScheduleNotification(notification, (success, error) => callback?.Invoke(error));
        }
