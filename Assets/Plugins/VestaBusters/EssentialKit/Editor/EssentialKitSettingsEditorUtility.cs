...
using VestaBusters.CoreLibrary.Editor.NativePlugins.UnityUI;
...
namespace VestaBusters.EssentialKit.Editor
{
    ...
    public static class EssentialKitSettingsEditorUtility
    {
        ...
        {
            ScriptingDefinesManager.AddDefine("ENABLE_VESTABUSTERS_ESSENTIAL_KIT");
        }
        
        public static void RemoveGlobalDefines()
        {
            ScriptingDefinesManager.RemoveDefine("ENABLE_VESTABUSTERS_ESSENTIAL_KIT");
        }
