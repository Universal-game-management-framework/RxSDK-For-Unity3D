...
namespace VestaBusters.EssentialKit.Editor.Build.Android
{
	...
	public class AndroidLibraryDependenciesGenerator
	{
		...
		private static readonly string BillingClientVersionString		= "5.2.1+";
		private static readonly string PlayServicesVersionString		= "23.1.0+";
		private static readonly string PlayServicesNearByVersionString	= "17.0.0+";
		private static readonly string PlayServicesAuthVersionString	= "20.4.1+";
