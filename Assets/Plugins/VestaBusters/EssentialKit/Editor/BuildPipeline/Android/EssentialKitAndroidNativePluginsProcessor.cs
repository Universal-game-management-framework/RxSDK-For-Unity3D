...
{
    public class EssentialKitAndroidNativePluginsProcessor : VestaBusters.CoreLibrary.Editor.NativePlugins.Build.Android.AndroidNativePluginsProcessor
    {
        #region Properties
