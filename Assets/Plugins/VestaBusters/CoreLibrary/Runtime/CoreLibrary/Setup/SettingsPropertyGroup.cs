...
namespace VestaBusters.CoreLibrary
{
    ...
    public abstract class SettingsPropertyGroup
    {
        ...
        public static void UpdateBuildConfigurationToSupportToggleFeatureUsageState()
        {
            ...
            {
                Debug.Log("[VestaBusters] Scripting runtime version changed to \'Latest\'. Kindly relaunch your editor.");
            ...
            {
                Debug.Log("[VestaBusters] Managed stripping level changed to \'Medium\'.");
