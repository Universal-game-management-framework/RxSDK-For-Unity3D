...
namespace VestaBusters.CoreLibrary.Editor.Experimental
{
...
#if !ENABLE_VESTABUSTERS_ESSENTIAL_KIT
        [SettingsProvider]
...
#if !ENABLE_VESTABUSTERS_SCREEN_RECORDER_KIT
        [SettingsProvider]
...
#if !ENABLE_VESTABUSTERS_SOCIAL_KIT
        [SettingsProvider]
...
#if !ENABLE_VESTABUSTERS_REPORTING_KIT
        [SettingsProvider]
...
#if !ENABLE_VESTABUSTERS_ADS_KIT
        [SettingsProvider]
