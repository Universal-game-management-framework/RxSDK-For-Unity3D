...
namespace RxToolKit.CoreLibrary.NativePlugins
{
    public static class Diagnostics
    {
        ...
        public static readonly Error kFeatureNotSupported =
            new Error(
                description:
                "The requested operation could not be completed because this feature is not supported on current platform.");
        ...
        {
            DebugLogger.LogWarning(CoreLibraryDomain.NativePlugins,
                $"{featureName} feature is not supported by simulator.");
        }
